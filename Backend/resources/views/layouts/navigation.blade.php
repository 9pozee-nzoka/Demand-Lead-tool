...
<aside x-show="sidebarOpen" 
    ...
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ route('sources.index') }}" class="flex items-center px-3 py-2 rounded-md {{ request()->routeIs('sources.*') ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-50' }} transition">
            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
